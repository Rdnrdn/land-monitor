...
class Lot(models.Model):
    ...
    notice_number = models.TextField(blank=True, null=True)
    notice_publish_date = models.DateTimeField(blank=True, null=True)
    notice_url = models.TextField(blank=True, null=True)
    ...
    contract_type_bucket = models.TextField(blank=True, null=True)
    contract_type_source_code = models.TextField(blank=True, null=True)
    contract_type_source_name = models.TextField(blank=True, null=True)
    land_restrictions_text = models.TextField(blank=True, null=True)
    contract_sign_period_text = models.TextField(blank=True, null=True)
    ...
    application_start_at = models.DateTimeField(blank=True, null=True)
    application_deadline = models.DateTimeField(blank=True, null=True)
    application_address = models.TextField(blank=True, null=True)
